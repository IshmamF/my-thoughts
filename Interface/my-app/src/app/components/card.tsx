...
export function GlowEffectCardBackground({text}: props) {
  return (
    <div className='relative h-44 w-2/3'>
      <GlowEffect
        ...
        blur='medium'
      />
      <div className='relative flex items-center justify-center h-full w-full rounded-lg bg-black p-2 text-white dark:bg-white dark:text-black'>
        <svg
          role='img'
